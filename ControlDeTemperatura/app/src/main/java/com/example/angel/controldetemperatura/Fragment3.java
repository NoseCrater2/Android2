...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.invernadero_3,container,false);
    }

    private Double tempToEntry = 0.0;
    public  boolean menos20 = false;
    public boolean mas20 = false;

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        textMax = (TextView)  getActivity().findViewById(R.id.txtMax3);
        textShowAll = (TextView)getActivity().findViewById(R.id.txtTodos3);
        btnShowAll = (Button)getActivity().findViewById(R.id.btnShowTodos3);
        numEntry = (EditText)getActivity().findViewById(R.id.editTemp3);
        btnAdd = (Button)getActivity().findViewById(R.id.btnAgregar3);
        textMinimo = (TextView)getActivity().findViewById(R.id.txtMin3);
        txtPromedio = (TextView)getActivity().findViewById(R.id.txtProm3);

        textMax.setText("Temperatura Máxima: "+getMaxInvIndividual(3));
        textMinimo.setText("Temperatura Minima: "+getMinInvIndividual(3));
        txtPromedio.setText("Temperatura Promedio: "+getPromInvIndividual(3));
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double minima = tempToEntry-getMinIndividualPerHour(3);
                double maxima  = getMaxIndividualPerHour(3)-tempToEntry;
                if(minima>=20.0){
    ...
    private String mostrarTodaInfoInv1(){
        ...
        Cursor cursor = getContext().getContentResolver().query(DataBase.TempsEntry.CONTENT_URI,projection, DataBase.TempsEntry.COLUMN_NO_INVERNADERO+" = 3",null,null);
